...
class Chatbot extends Component {
  ...
  async df_client_call(request) {
    try {
      ...
      console.log(process.env.REACT_APP_DF_SESSION_ID);
        ...
        <div key={i}>
          <div className="card-panel grey lighten-5 z-depth-1">
            <div>
              ...
              <div>
                <div>{this.renderCards(message.msg.payload.cards)}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        <RB.Modal.Dialog>
          <RB.Modal.Header
            ...
            closeButton
          >
            <RB.Modal.Title>ChatBot</RB.Modal.Title>
          </RB.Modal.Header>
          {/* 
            <RB.Modal.Body>
              <p>Modal body text goes here.</p>
            </RB.Modal.Body> */}
          <RB.Modal.Body className="chatbotBody">
            <div
              id="chatbot"
              style={{
                minHeight: 500,
          ...
          {/* <RB.Modal.Footer>
              ...
              <RB.Button variant="primary">Save changes</RB.Button>
            </RB.Modal.Footer> */}
        </RB.Modal.Dialog>
        <RB.Nav>
          {/* <div>
